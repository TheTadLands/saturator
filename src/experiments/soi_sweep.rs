...
pub fn run_soi_sweep_experiment(
    ...
    println!("\n  {:>7} {:>7} | {:>12} {:>12} {:>12} | {:>8} | {:>10} | {:>6} {:>6}",
             "soi", "total", "victim cpu", "victim io", "victim tot", "change%", "soi ops/s", "cpu%", "io%");
    println!("  {}", "-".repeat(100));
    ...
    println!("  {:>7} {:>7} | {:>12.0} {:>12.0} {:>12.0} | {:>7.1}% | {:>10} | {:>5.1}% {:>5.1}%",
             0, victim_workers, base_cpu, base_io, baseline_total, 0.0, "-",
             base_metrics.cpu_pct, base_metrics.io_util_pct);
    ...
    while soi_count <= params.max_workers {
        ...
        println!("  {:>7} {:>7} | {:>12.0} {:>12.0} {:>12.0} | {:>7.1}% | {:>10.0} | {:>5.1}% {:>5.1}%",
